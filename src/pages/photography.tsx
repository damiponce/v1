...
export const getStaticProps: GetStaticProps = async (context) => {
   var allPicturesData = await getAllPhotos();
   //  allPicturesData = shuffle(allPicturesData);
   allPicturesData.sort(function (a, b) {
      ...
      <Layout>
         ...
         <div className="section">
            ...
            <div className="section-intro">
               ...
               <p>
                  Desde una piedra hasta una nube rara, cualquier foto puede
                  tener una historia detrás, y eso es lo que me encanta de este
                  arte.
               </p>
            </div>
         </div>
